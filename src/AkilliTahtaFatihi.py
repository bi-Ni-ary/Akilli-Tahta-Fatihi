...
import subprocess, pyautogui, time, tempfile, random, os, webbrowser, sys
...
by Ni
for Win10 x64
https://github.com/bi-Ni-ary/Akilli-Tahta-Fatihi
        ...
        match x:
            ...
            case 20:  # Sahte Güncellenme Ekranı 
                try:
                    ...
                    try:
                        gif = Image.open(resourcePath("assets/loading.gif"))
                        gifFrames = []
